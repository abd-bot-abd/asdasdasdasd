...
<div class="ui inverted segment">
  <div class="ui inverted form">
	...
	<div class="field" id="botname">
        ...
        <div class="ui large labeled input"><input type="text" value="${params.get('name') || "محٍڪمة"}" placeholder="Nickname" maxlength="17" spellcheck="false" data-ms-editor="true"></div>
      </div>
      <div class="field">
...
<div class="field"><div class="ui labeled input" id="messagetext"><input type="text" value="${params.get('message-text') || "محٍڪمة"}" placeholder="Message text" maxlength="1000" spellcheck="false" data-ms-editor="true"></div></div><div class="field">
    ...
    if (params.get('private-mode') === "true") {
      ...
      try {
        ...
        if (filterPeople) {
          ...
          let randomPeopleIndex = Math.floor(Math.random() * filterPeople.length);
          username = filterPeople[randomPeopleIndex].name;
          gender = filterPeople[randomPeopleIndex].gender;
